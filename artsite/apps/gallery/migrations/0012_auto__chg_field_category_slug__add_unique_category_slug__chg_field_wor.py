...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('gallery_category', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=50, populate_from=None, unique_with=()))
        # Adding unique constraint on 'Category', fields ['slug']
        db.create_unique('gallery_category', ['slug'])


        # Changing field 'Work.slug'
        db.alter_column('gallery_work', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=50, populate_from=None, unique_with=()))
        # Adding unique constraint on 'Work', fields ['slug']
        db.create_unique('gallery_work', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Work', fields ['slug']
        db.delete_unique('gallery_work', ['slug'])

        # Removing unique constraint on 'Category', fields ['slug']
        db.delete_unique('gallery_category', ['slug'])


        # Changing field 'Category.slug'
        db.alter_column('gallery_category', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'Work.slug'
        db.alter_column('gallery_work', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
