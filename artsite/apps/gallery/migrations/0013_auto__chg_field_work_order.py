...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Work.order'
        db.alter_column('gallery_work', 'order', self.gf('django.db.models.fields.SmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'Work.order'
        db.alter_column('gallery_work', 'order', self.gf('django.db.models.fields.SmallIntegerField')(null=True))
