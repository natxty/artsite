...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Work.width'
        db.alter_column('gallery_work', 'width', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'Work.depth'
        db.alter_column('gallery_work', 'depth', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'Work.height'
        db.alter_column('gallery_work', 'height', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Work.width'
        db.alter_column('gallery_work', 'width', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

        # Changing field 'Work.depth'
        db.alter_column('gallery_work', 'depth', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

        # Changing field 'Work.height'
        db.alter_column('gallery_work', 'height', self.gf('django.db.models.fields.SmallIntegerField')(null=True))
