...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Work.date_created'
        db.alter_column('gallery_work', 'date_created', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Work.date_created'
        db.alter_column('gallery_work', 'date_created', self.gf('django.db.models.fields.DateTimeField')())
