...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Download.download'
        db.alter_column('gallery_download', 'download', self.gf('django.db.models.fields.files.FileField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Download.download'
        db.alter_column('gallery_download', 'download', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))
    ...
    models = {
        ...
        'gallery.work': {
            'Meta': {'ordering': "('position',)", 'object_name': 'Work'},
